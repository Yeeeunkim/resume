...
document.getElementById('5').addEventListener('click', currentImageSlide.bind(null,5));
document.getElementById('6').addEventListener('click', currentImageSlide.bind(null,6));
document.getElementById('7').addEventListener('click', currentImageSlide.bind(null,7));
document.getElementById('8').addEventListener('click', currentImageSlide.bind(null,8));
document.getElementById('9').addEventListener('click', currentImageSlide.bind(null,9));
document.getElementById('10').addEventListener('click', currentImageSlide.bind(null,10));
document.getElementById('11').addEventListener('click', currentImageSlide.bind(null,11));
document.getElementById('12').addEventListener('click', currentImageSlide.bind(null,12));
document.getElementById('13').addEventListener('click', currentImageSlide.bind(null,13));
document.getElementById('14').addEventListener('click', currentImageSlide.bind(null,14));
document.getElementById('15').addEventListener('click', currentImageSlide.bind(null,15));
document.getElementById('16').addEventListener('click', currentImageSlide.bind(null,16));
document.getElementById('17').addEventListener('click', currentImageSlide.bind(null,17));
document.getElementById('18').addEventListener('click', currentImageSlide.bind(null,18));
document.getElementById('19').addEventListener('click', currentImageSlide.bind(null,19));
document.getElementById('20').addEventListener('click', currentImageSlide.bind(null,20));
document.getElementById('21').addEventListener('click', currentImageSlide.bind(null,21));
/* PORTFOLIO AREA */
filterSelection('all');
...
document.getElementById('cont').addEventListener('click', filterSelection.bind(null, 'cont'));
document.getElementById('invoice').addEventListener('click', filterSelection.bind(null, 'invoice'));
document.getElementById('sbdc').addEventListener('click', filterSelection.bind(null, 'sbdc'));
...
document.getElementById('navbarAbout').addEventListener('click', moveTo.bind(null,'about1'));
document.getElementById('navbarService').addEventListener('click', moveTo.bind(null,'1'));
